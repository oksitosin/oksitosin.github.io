Mlconf New York / March 24, 2017
-------------

MLConf NYC was held in NYC for the 4th time and I was one of the lucky attendees for the 1st time this year. (Thank you Women in Machine Learning and Data Science for giving me this opportunity :) )
...
1- The first talk was from **Corinna Cortes, Head of Research at Google**. Her research work is well-known in particular for her contributions to the theoretical foundations of support vector machines (SVMs).
...
Here are some recent papers on hyperparamater tuning:
Google: [AdaNet] (https://arxiv.org/abs/1607.01097) 
For her slides: https://es.slideshare.net/SessionsEvents/corinna-cortes-head-of-research-google-at-mlconf-nyc-2017
...
- Grid Search
-  Random Search
For more information here is a post about her talk and slides: http://blog.sigopt.com/post/158968647258/common-problems-in-hyperparameter-optimization
https://www.slideshare.net/SessionsEvents/alexandra-johnson-software-engineer-sigopt
...
and library he developed, “Annoy” that uses a forest of random tree to do fast and approximate nearest neighbor queries in high dimensional spaces. 
...
For more details and python code that demonstrates Deep Deterministic Policy Gradient (DDPG) with Keras, please see: https://yanpanlau.github.io/2016/10/11/Torcs-Keras.html
